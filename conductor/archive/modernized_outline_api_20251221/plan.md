...
## Phase 4: Parser & Final Integration [checkpoint: acdd64b]
- [x] Task: Update `OutlineParser` to parse existing PDF outlines into the new `BookmarkNode` tree. [d146791]
- [x] Task: Final cleanup of any remaining legacy outline code or obsolete properties. [d146791]
- [x] Task: Write integration tests for page copying and mixed bookmark types (Remote/Action). [e657a02]
- [x] Task: Conductor - User Manual Verification 'Phase 4: Parser & Final Integration' (Protocol in workflow.md) [acdd64b]
