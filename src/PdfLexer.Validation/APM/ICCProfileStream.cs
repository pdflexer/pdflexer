...
internal partial class APM_ICCProfileStream__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.3m:
                ...
                {
                    ctx.Fail<APM_ICCProfileStream>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.4m:
    ...
    {
        "Alternate", "DecodeParms", "DestOutputProfile", "F", "FDecodeParms", "FFilter", "Filter", "Length", "N", "Range"
    };
    public static HashSet<string> AllowedFields_14 { get; } = new HashSet<string> 
    {
        "Alternate", "DecodeParms", "DestOutputProfile", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Metadata", "N", "Range"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "Alternate", "DecodeParms", "DestOutputProfile", "DL", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Metadata", "N", "Range"
    };
