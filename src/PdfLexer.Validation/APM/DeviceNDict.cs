...
internal partial class APM_DeviceNDict__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.5m:
                ...
                {
                    ctx.Fail<APM_DeviceNDict>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.6m:
            case 1.7m:
    ...
    public static List<string> AllowedFields_13_14_15 { get; } = new List<string> 
    {
        "Colorants"
    };
    public static List<string> AllowedFields_16_17_18_19_20 { get; } = new List<string> 
    {
        "Colorants", "MixingHints", "Process", "Subtype"
    };
