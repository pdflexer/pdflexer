...
internal partial class APM_OPIVersion13Dict__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_OPIVersion13Dict>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
    ...
    {
        "Color", "ColorType", "Comments", "CropFixed", "CropRect", "F", "GrayMap", "ID", "ImageType", "Overprint", "Position", "Resolution", "Size", "Tags", "Tint", "Transparency", "Type", "Version"
    };
