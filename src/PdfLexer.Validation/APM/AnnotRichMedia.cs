...
internal partial class APM_AnnotRichMedia__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_AnnotRichMedia>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "AP", "AS", "Border", "C", "Contents", "F", "M", "NM", "OC", "P", "Rect", "RichMediaContent", "RichMediaSettings", "StructParent", "Subtype", "Type"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AF", "AP", "AS", "BM", "Border", "C", "ca", "CA", "Contents", "F", "Lang", "M", "NM", "OC", "P", "Rect", "RichMediaContent", "RichMediaSettings", "StructParent", "Subtype", "Type"
    };
