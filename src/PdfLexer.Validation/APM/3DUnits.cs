...
internal partial class APM_3DUnits__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 2.0m:
                ...
                {
                    ctx.Fail<APM_3DUnits>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
    ...
    {
        "DSm", "DSn", "DU", "TSm", "TSn", "TU", "USm", "USn", "UU"
    };
...
internal partial class APM_3DUnits_TSm__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_TSm>(obj, "TSm", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_3DUnits_TSn__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_TSn>(obj, "TSn", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_3DUnits_TU__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_3DUnits_TU>(obj, "TU", IndirectRequirement.Either);
        if (((obj.ContainsKey(PdfName.TSm)||obj.ContainsKey(PdfName.TSn))) && val == null) {
...
internal partial class APM_3DUnits_USm__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_USm>(obj, "USm", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_3DUnits_USn__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_USn>(obj, "USn", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_3DUnits_UU__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_3DUnits_UU>(obj, "UU", IndirectRequirement.Either);
        if (((obj.ContainsKey(PdfName.USm)||obj.ContainsKey(PdfName.USn))) && val == null) {
...
internal partial class APM_3DUnits_DSm__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_DSm>(obj, "DSm", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_3DUnits_DSn__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfNumber, APM_3DUnits_DSn>(obj, "DSn", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_3DUnits_DU__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_3DUnits_DU>(obj, "DU", IndirectRequirement.Either);
        if (((obj.ContainsKey(PdfName.DSm)||obj.ContainsKey(PdfName.DSn))) && val == null) {
