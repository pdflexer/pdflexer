...
internal partial class APM_FontDescriptorType1__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.0m:
                ...
                {
                    ctx.Fail<APM_FontDescriptorType1>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.1m:
    ...
    {
        "Ascent", "AvgWidth", "CapHeight", "CharSet", "Descent", "Flags", "FontBBox", "FontFile", "FontName", "ItalicAngle", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Type", "XHeight"
    };
    public static HashSet<string> AllowedFields_12_13_14 { get; } = new HashSet<string> 
    {
        "Ascent", "AvgWidth", "CapHeight", "CharSet", "Descent", "Flags", "FontBBox", "FontFile", "FontFile3", "FontName", "ItalicAngle", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Type", "XHeight"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19 { get; } = new HashSet<string> 
    {
        "Ascent", "AvgWidth", "CapHeight", "CharSet", "Descent", "Flags", "FontBBox", "FontFamily", "FontFile", "FontFile3", "FontName", "FontStretch", "FontWeight", "ItalicAngle", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Type", "XHeight"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "Ascent", "AvgWidth", "CapHeight", "Descent", "Flags", "FontBBox", "FontFamily", "FontFile", "FontFile3", "FontName", "FontStretch", "FontWeight", "ItalicAngle", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Type", "XHeight"
    };
