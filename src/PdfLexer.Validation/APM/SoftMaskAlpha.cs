    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 2.0m:
                ...
                {
                    ctx.Fail<APM_SoftMaskAlpha>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
...
internal partial class APM_SoftMaskAlpha_Type__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_SoftMaskAlpha_Type>(obj, "Type", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_SoftMaskAlpha_S__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfName, APM_SoftMaskAlpha_S>(obj, "S", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_SoftMaskAlpha_G__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfStream, APM_SoftMaskAlpha_G>(obj, "G", IndirectRequirement.MustBeIndirect);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_SoftMaskAlpha_BC__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfArray, APM_SoftMaskAlpha_BC>(obj, "BC", IndirectRequirement.Either);
        if (val == null) { return; }
