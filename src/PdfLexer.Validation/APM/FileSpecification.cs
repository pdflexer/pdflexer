...
internal partial class APM_FileSpecification__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.1m:
                ...
                {
                    ctx.Fail<APM_FileSpecification>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.2m:
            ...
            case 1.4m:
            case 1.5m:
                foreach (var extra in obj.Keys.Where(x=> !AllowedFields_13_14_15.Contains(x)))
                {
                    ctx.Fail<APM_FileSpecification>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
    ...
    {
        "DOS", "F", "FS", "ID", "Mac", "Type", "Unix"
    };
    public static HashSet<string> AllowedFields_12 { get; } = new HashSet<string> 
    {
        "DOS", "F", "FS", "ID", "Mac", "Type", "Unix", "V"
    };
    public static HashSet<string> AllowedFields_13_14_15 { get; } = new HashSet<string> 
    {
        "DOS", "EF", "F", "FS", "ID", "Mac", "RF", "Type", "Unix", "V"
    };
    public static HashSet<string> AllowedFields_16 { get; } = new HashSet<string> 
    {
        "Desc", "DOS", "EF", "F", "FS", "ID", "Mac", "RF", "Type", "Unix", "V"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "CI", "Desc", "DOS", "EF", "F", "FS", "ID", "Mac", "RF", "Thumb", "Type", "UF", "Unix", "V"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AFRelationship", "CI", "Desc", "EF", "EP", "F", "FS", "ID", "RF", "Thumb", "Type", "UF", "V"
    };
...
internal partial class APM_FileSpecification_Type__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_FileSpecification_Type>(obj, "Type", IndirectRequirement.Either);
...
internal partial class APM_FileSpecification_FS__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_FileSpecification_FS>(obj, "FS", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_FileSpecification_F__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_F>(obj, "F", IndirectRequirement.Either);
...
internal partial class APM_FileSpecification_UF__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_UF>(obj, "UF", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_DOS__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_DOS>(obj, "DOS", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_Mac__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_Mac>(obj, "Mac", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_Unix__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_Unix>(obj, "Unix", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_ID__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfArray, APM_FileSpecification_ID>(obj, "ID", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_FileSpecification_V__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfBoolean, APM_FileSpecification_V>(obj, "V", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_EF__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_FileSpecification_EF>(obj, "EF", IndirectRequirement.Either);
...
internal partial class APM_FileSpecification_RF__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_FileSpecification_RF>(obj, "RF", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_FileSpecification_Desc__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_FileSpecification_Desc>(obj, "Desc", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FileSpecification_CI__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_FileSpecification_CI>(obj, "CI", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_FileSpecification_Thumb__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfStream, APM_FileSpecification_Thumb>(obj, "Thumb", IndirectRequirement.MustBeIndirect);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_FileSpecification_AFRelationship__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_FileSpecification_AFRelationship>(obj, "AFRelationship", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_FileSpecification_EP__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_FileSpecification_EP>(obj, "EP", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
