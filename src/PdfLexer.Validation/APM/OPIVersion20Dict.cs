...
internal partial class APM_OPIVersion20Dict__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_OPIVersion20Dict>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
    ...
    {
        "CropRect", "F", "IncludedImageDimensions", "IncludedImageQuality", "Inks", "MainImage", "Overprint", "Size", "Tags", "Type", "Version"
    };
