    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 2.0m:
                ...
                {
                    ctx.Fail<APM_LinearizationParameterDict>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
...
internal partial class APM_LinearizationParameterDict_Linearized__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfNumber, APM_LinearizationParameterDict_Linearized>(obj, "Linearized", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_L__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_LinearizationParameterDict_L>(obj, "L", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_H__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfArray, APM_LinearizationParameterDict_H>(obj, "H", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_O__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_LinearizationParameterDict_O>(obj, "O", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_E__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_LinearizationParameterDict_E>(obj, "E", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_N__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_LinearizationParameterDict_N>(obj, "N", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_T__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_LinearizationParameterDict_T>(obj, "T", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_LinearizationParameterDict_P__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_LinearizationParameterDict_P>(obj, "P", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
