...
internal partial class APM_AnnotCircle__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.3m:
                ...
                {
                    ctx.Fail<APM_AnnotCircle>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.4m:
    ...
    {
        "AP", "AS", "Border", "BS", "C", "CA", "Contents", "F", "IC", "M", "NM", "P", "Popup", "Rect", "StructParent", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_15 { get; } = new HashSet<string> 
    {
        "AP", "AS", "BE", "Border", "BS", "C", "CA", "Contents", "CreationDate", "F", "IC", "IRT", "M", "NM", "OC", "P", "Popup", "RC", "RD", "Rect", "StructParent", "Subj", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_16 { get; } = new HashSet<string> 
    {
        "AP", "AS", "BE", "Border", "BS", "C", "CA", "Contents", "CreationDate", "F", "IC", "IRT", "IT", "M", "NM", "OC", "P", "Popup", "RC", "RD", "Rect", "RT", "StructParent", "Subj", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "AP", "AS", "BE", "Border", "BS", "C", "CA", "Contents", "CreationDate", "ExData", "F", "IC", "IRT", "IT", "M", "NM", "OC", "P", "Popup", "RC", "RD", "Rect", "RT", "StructParent", "Subj", "Subtype", "T", "Type"
    };
