...
internal partial class APM_3DStream__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.6m:
                ...
                {
                    ctx.Fail<APM_3DStream>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.7m:
            case 1.8m:
    ...
    {
        "DecodeParms", "DL", "DV", "F", "FDecodeParms", "FFilter", "Filter", "Length", "OnInstantiate", "Resources", "Subtype", "Type", "VA"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "AN", "DecodeParms", "DL", "DV", "F", "FDecodeParms", "FFilter", "Filter", "Length", "OnInstantiate", "Resources", "Subtype", "Type", "VA"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AN", "ColorSpace", "DecodeParms", "DL", "DV", "F", "FDecodeParms", "FFilter", "Filter", "Length", "OnInstantiate", "Resources", "Subtype", "Type", "VA"
    };
