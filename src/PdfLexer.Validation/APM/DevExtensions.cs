...
internal partial class APM_DevExtensions__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_DevExtensions>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "BaseVersion", "ExtensionLevel", "Type"
    };
...
internal partial class APM_DevExtensions_Type__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_DevExtensions_Type>(obj, "Type", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_DevExtensions_BaseVersion__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfName, APM_DevExtensions_BaseVersion>(obj, "BaseVersion", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_DevExtensions_ExtensionLevel__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_DevExtensions_ExtensionLevel>(obj, "ExtensionLevel", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_DevExtensions_URL__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_DevExtensions_URL>(obj, "URL", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
...
internal partial class APM_DevExtensions_ExtensionRevision__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_DevExtensions_ExtensionRevision>(obj, "ExtensionRevision", IndirectRequirement.MustBeDirect);
        if (val == null) { return; }
