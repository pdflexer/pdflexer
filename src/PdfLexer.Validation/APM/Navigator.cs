...
internal partial class APM_Navigator__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_Navigator>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "APIVersion", "Category", "Desc", "Icon", "ID", "InitialFields", "LoadType", "Locale", "Name", "Resources", "Strings", "SWF", "Version"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "APIVersion", "Category", "Desc", "Icon", "ID", "InitialFields", "Layout", "LoadType", "Locale", "Name", "Resources", "Strings", "SWF", "Type", "Version"
    };
