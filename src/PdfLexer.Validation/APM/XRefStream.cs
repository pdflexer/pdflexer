...
internal partial class APM_XRefStream__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_XRefStream>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "DecodeParms", "DL", "Encrypt", "F", "FDecodeParms", "FFilter", "Filter", "ID", "Index", "Info", "Length", "Prev", "Root", "Size", "Type", "W"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AuthCode", "DecodeParms", "DL", "Encrypt", "F", "FDecodeParms", "FFilter", "Filter", "ID", "Index", "Info", "Length", "Prev", "Root", "Size", "Type", "W"
    };
            ...
            case PdfObjectType.ArrayObj:
                {
                    ...
                    if (!((eq(((DecodeParms as PdfArray)?.Count),((Filter as PdfArray)?.Count))&&!Contains(val, PdfName.Crypt)))) 
                    {
