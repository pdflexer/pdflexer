...
internal partial class APM_FontDescriptorCIDType0__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.4m:
                ...
                {
                    ctx.Fail<APM_FontDescriptorCIDType0>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.5m:
            case 1.6m:
    ...
    {
        "Ascent", "AvgWidth", "CapHeight", "CIDSet", "Descent", "FD", "Flags", "FontBBox", "FontFile", "FontFile3", "FontName", "ItalicAngle", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Style", "Type", "XHeight"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19 { get; } = new HashSet<string> 
    {
        "Ascent", "AvgWidth", "CapHeight", "CIDSet", "Descent", "FD", "Flags", "FontBBox", "FontFamily", "FontFile", "FontFile3", "FontName", "FontStretch", "FontWeight", "ItalicAngle", "Lang", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Style", "Type", "XHeight"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "Ascent", "AvgWidth", "CapHeight", "Descent", "FD", "Flags", "FontBBox", "FontFamily", "FontFile", "FontFile3", "FontName", "FontStretch", "FontWeight", "ItalicAngle", "Lang", "Leading", "MaxWidth", "MissingWidth", "StemH", "StemV", "Style", "Type", "XHeight"
    };
