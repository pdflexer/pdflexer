...
internal partial class APM_XObjectImage__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.0m:
                ...
                {
                    ctx.Fail<APM_XObjectImage>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.1m:
    ...
    {
        "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "F", "Filter", "Height", "ImageMask", "Interpolate", "Length", "Name", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_11 { get; } = new HashSet<string> 
    {
        "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "F", "Filter", "Height", "ImageMask", "Intent", "Interpolate", "Length", "Name", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_12 { get; } = new HashSet<string> 
    {
        "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Height", "ImageMask", "Intent", "Interpolate", "Length", "Name", "OPI", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_13 { get; } = new HashSet<string> 
    {
        "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Name", "OPI", "StructParent", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_14 { get; } = new HashSet<string> 
    {
        "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Metadata", "Name", "OPI", "SMask", "StructParent", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_15 { get; } = new HashSet<string> 
    {
        "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Metadata", "Name", "OC", "OPI", "SMask", "SMaskInData", "StructParent", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_16 { get; } = new HashSet<string> 
    {
        "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "GTS_Encapsulated", "GTS_Env", "GTS_Scope", "GTS_XID", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Metadata", "Name", "OC", "OPI", "SMask", "SMaskInData", "StructParent", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "GTS_Encapsulated", "GTS_Env", "GTS_Scope", "GTS_XID", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Measure", "Metadata", "Name", "OC", "OPI", "PtData", "SMask", "SMaskInData", "StructParent", "Subtype", "Type", "Width"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AF", "Alternates", "BitsPerComponent", "ColorSpace", "Decode", "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "GTS_Encapsulated", "GTS_Env", "GTS_Scope", "GTS_XID", "Height", "ID", "ImageMask", "Intent", "Interpolate", "Length", "Mask", "Measure", "Metadata", "OC", "PtData", "SMask", "SMaskInData", "StructParent", "Subtype", "Type", "Width"
    };
...
internal partial class APM_XObjectImage_Type__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_XObjectImage_Type>(obj, "Type", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_XObjectImage_Subtype__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfName, APM_XObjectImage_Subtype>(obj, "Subtype", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_XObjectImage_Width__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_XObjectImage_Width>(obj, "Width", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_XObjectImage_Height__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_XObjectImage_Height>(obj, "Height", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_XObjectImage_BitsPerComponent__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var Filter = obj.Get("Filter");
        var ImageMask = obj.Get("ImageMask");
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_XObjectImage_BitsPerComponent>(obj, "BitsPerComponent", IndirectRequirement.Either);
...
internal partial class APM_XObjectImage_Intent__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_XObjectImage_Intent>(obj, "Intent", IndirectRequirement.Either);
        if (val == null) { return; }
...
internal partial class APM_XObjectImage_ImageMask__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfBoolean, APM_XObjectImage_ImageMask>(obj, "ImageMask", IndirectRequirement.Either);
        if (val == null) { return; }
        var ImageMask = obj.Get("ImageMask");
...
internal partial class APM_XObjectImage_Decode__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfArray, APM_XObjectImage_Decode>(obj, "Decode", IndirectRequirement.Either);
        if (val == null) { return; }
        // special case is an fn:Ignore, not pertinent to validation
        // no value restrictions
...
internal partial class APM_XObjectImage_Interpolate__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfBoolean, APM_XObjectImage_Interpolate>(obj, "Interpolate", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_XObjectImage_Alternates__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfArray, APM_XObjectImage_Alternates>(obj, "Alternates", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_XObjectImage_SMask__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfStream, APM_XObjectImage_SMask>(obj, "SMask", IndirectRequirement.MustBeIndirect);
        if (val == null) { return; }
...
internal partial class APM_XObjectImage_SMaskInData__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_XObjectImage_SMaskInData>(obj, "SMaskInData", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_XObjectImage_Name__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_XObjectImage_Name>(obj, "Name", IndirectRequirement.Either);
...
internal partial class APM_XObjectImage_StructParent__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_XObjectImage_StructParent>(obj, "StructParent", IndirectRequirement.Either);
...
internal partial class APM_XObjectImage_ID__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_XObjectImage_ID>(obj, "ID", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_XObjectImage_OPI__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_XObjectImage_OPI>(obj, "OPI", IndirectRequirement.Either);
        if (val == null) { return; }
        // special case is an fn:Ignore, not pertinent to validation
        // no value restrictions
...
internal partial class APM_XObjectImage_Metadata__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfStream, APM_XObjectImage_Metadata>(obj, "Metadata", IndirectRequirement.MustBeIndirect);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_XObjectImage_OC__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_XObjectImage_OC>(obj, "OC", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_XObjectImage_Measure__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_XObjectImage_Measure>(obj, "Measure", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_XObjectImage_PtData__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfDictionary, APM_XObjectImage_PtData>(obj, "PtData", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
...
internal partial class APM_XObjectImage_Length__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_XObjectImage_Length>(obj, "Length", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_XObjectImage_DL__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_XObjectImage_DL>(obj, "DL", IndirectRequirement.Either);
        if (val == null) { return; }
        var DL = obj.Get("DL");
        if (!(gte(DL,0))) 
        {
...
internal partial class APM_XObjectImage_GTS_XID__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_XObjectImage_GTS_XID>(obj, "GTS_XID", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_XObjectImage_GTS_Scope__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_XObjectImage_GTS_Scope>(obj, "GTS_Scope", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_XObjectImage_GTS_Env__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        var (val, wasIR) = ctx.GetOptional<PdfString, APM_XObjectImage_GTS_Env>(obj, "GTS_Env", IndirectRequirement.Either);
...
internal partial class APM_XObjectImage_GTS_Encapsulated__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfBoolean, APM_XObjectImage_GTS_Encapsulated>(obj, "GTS_Encapsulated", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
