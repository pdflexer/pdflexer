...
internal partial class APM_FieldSig__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.4m:
                ...
                {
                    ctx.Fail<APM_FieldSig>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.5m:
            case 1.6m:
    ...
    {
        "AA", "DA", "DV", "Ff", "FT", "Kids", "Parent", "Q", "T", "TM", "TU", "V"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "AA", "DA", "DS", "DV", "Ff", "FT", "Kids", "Lock", "Parent", "Q", "RV", "SV", "T", "TM", "TU", "V"
    };
