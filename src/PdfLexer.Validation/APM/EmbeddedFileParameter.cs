...
internal partial class APM_EmbeddedFileParameter__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_EmbeddedFileParameter>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "CheckSum", "CreationDate", "Mac", "ModDate", "Size"
    };
    public static List<string> AllowedFields_20 { get; } = new List<string> 
    {
        "CheckSum", "CreationDate", "ModDate", "Size"
    };
