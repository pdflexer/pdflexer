...
internal partial class APM_AnnotFileAttachment__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.3m:
                ...
                {
                    ctx.Fail<APM_AnnotFileAttachment>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.4m:
    ...
    {
        "AP", "AS", "Border", "C", "Contents", "F", "FS", "M", "Name", "P", "Popup", "Rect", "StructParent", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_14 { get; } = new HashSet<string> 
    {
        "AP", "AS", "Border", "C", "CA", "Contents", "F", "FS", "M", "Name", "NM", "P", "Popup", "Rect", "StructParent", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_15 { get; } = new HashSet<string> 
    {
        "AP", "AS", "Border", "C", "CA", "Contents", "CreationDate", "F", "FS", "IRT", "M", "Name", "NM", "OC", "P", "Popup", "RC", "Rect", "StructParent", "Subj", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_16 { get; } = new HashSet<string> 
    {
        "AP", "AS", "Border", "C", "CA", "Contents", "CreationDate", "F", "FS", "IRT", "IT", "M", "Name", "NM", "OC", "P", "Popup", "RC", "Rect", "RT", "StructParent", "Subj", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "AP", "AS", "Border", "C", "CA", "Contents", "CreationDate", "ExData", "F", "FS", "IRT", "IT", "M", "Name", "NM", "OC", "P", "Popup", "RC", "Rect", "RT", "StructParent", "Subj", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "AF", "AP", "AS", "BM", "Border", "C", "ca", "CA", "Contents", "CreationDate", "ExData", "F", "FS", "IRT", "IT", "Lang", "M", "Name", "NM", "OC", "P", "Popup", "RC", "Rect", "RT", "StructParent", "Subj", "Subtype", "T", "Type"
    };
