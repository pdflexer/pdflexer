...
internal partial class APM_ViewerPreferences__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.2m:
                ...
                {
                    ctx.Fail<APM_ViewerPreferences>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.3m:
    ...
    {
        "CenterWindow", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode"
    };
    public static HashSet<string> AllowedFields_13 { get; } = new HashSet<string> 
    {
        "CenterWindow", "Direction", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode"
    };
    public static HashSet<string> AllowedFields_14_15 { get; } = new HashSet<string> 
    {
        "CenterWindow", "Direction", "DisplayDocTitle", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode", "PrintArea", "PrintClip", "ViewArea", "ViewClip"
    };
    public static HashSet<string> AllowedFields_16 { get; } = new HashSet<string> 
    {
        "CenterWindow", "Direction", "DisplayDocTitle", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode", "PrintArea", "PrintClip", "PrintScaling", "ViewArea", "ViewClip"
    };
    public static HashSet<string> AllowedFields_17_18_19 { get; } = new HashSet<string> 
    {
        "CenterWindow", "Direction", "DisplayDocTitle", "Duplex", "Enforce", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode", "NumCopies", "PickTrayByPDFSize", "PrintArea", "PrintClip", "PrintPageRange", "PrintScaling", "ViewArea", "ViewClip"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "CenterWindow", "Direction", "DisplayDocTitle", "Duplex", "Enforce", "FitWindow", "HideMenubar", "HideToolbar", "HideWindowUI", "NonFullScreenPageMode", "NumCopies", "PickTrayByPDFSize", "PrintPageRange", "PrintScaling"
    };
