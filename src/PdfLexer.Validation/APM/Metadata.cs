...
internal partial class APM_Metadata__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.4m:
                ...
                {
                    ctx.Fail<APM_Metadata>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.5m:
            case 1.6m:
    ...
    {
        "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Subtype", "Type"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Subtype", "Type"
    };
