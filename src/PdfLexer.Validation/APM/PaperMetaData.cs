...
internal partial class APM_PaperMetaData__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 2.0m:
                ...
                {
                    ctx.Fail<APM_PaperMetaData>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
    ...
    {
        "Caption", "ECC", "Height", "nCodeWordCol", "nCodeWordRow", "Resolution", "Symbology", "Type", "Version", "Width", "XSymWidth", "YSymHeight"
    };
