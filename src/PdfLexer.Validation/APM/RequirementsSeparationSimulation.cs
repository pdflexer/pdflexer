...
internal partial class APM_RequirementsSeparationSimulation__Base : ISpecification<PdfDictionary>
{
    ...
    {
        ctx.Run<APM_RequirementsSeparationSimulation_Type, PdfDictionary>(stack, obj, parent);
        ctx.Run<APM_RequirementsSeparationSimulation_S, PdfDictionary>(stack, obj, parent);
        ctx.Run<APM_RequirementsSeparationSimulation_V, PdfDictionary>(stack, obj, parent);
        ctx.Run<APM_RequirementsSeparationSimulation_RH, PdfDictionary>(stack, obj, parent);
        ctx.Run<APM_RequirementsSeparationSimulation_Penalty, PdfDictionary>(stack, obj, parent);
        switch (ctx.Version) {
            case 2.0m:
                foreach (var extra in obj.Keys.Where(x=> !AllowedFields_20.Contains(x)))
                {
                    ctx.Fail<APM_RequirementsSeparationSimulation>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            default:
                break;
    ...
    {
        var c = ctx.Clone();
        c.Run<APM_RequirementsSeparationSimulation_Type, PdfDictionary>(new CallStack(), obj, null);
        if (c.Errors.Any())
        {
            return false;
        }
...
internal partial class APM_RequirementsSeparationSimulation_Type__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfName, APM_RequirementsSeparationSimulation_Type>(obj, "Type", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_RequirementsSeparationSimulation_S__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfName, APM_RequirementsSeparationSimulation_S>(obj, "S", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_RequirementsSeparationSimulation_V__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (utval, wasIR) = ctx.GetOptional<APM_RequirementsSeparationSimulation_V>(obj, "V", IndirectRequirement.Either);
        ...
        switch (utval.Type) 
        {
            ...
            default:
                ctx.Fail<APM_RequirementsSeparationSimulation_V>("V is required to one of 'dictionary;name', was " + utval.Type);
                return;
        }
    }
...
internal partial class APM_RequirementsSeparationSimulation_RH__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (utval, wasIR) = ctx.GetOptional<APM_RequirementsSeparationSimulation_RH>(obj, "RH", IndirectRequirement.Either);
        if (utval == null) { return; }
        switch (utval.Type) 
        {
            ...
            default:
                ctx.Fail<APM_RequirementsSeparationSimulation_RH>("RH is required to one of 'array;dictionary', was " + utval.Type);
                return;
        }
    }
...
internal partial class APM_RequirementsSeparationSimulation_Penalty__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_RequirementsSeparationSimulation_Penalty>(obj, "Penalty", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
