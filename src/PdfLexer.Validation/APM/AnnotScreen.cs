...
internal partial class APM_AnnotScreen__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.9m:
                ...
                {
                    ctx.Fail<APM_AnnotScreen>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 2.0m:
    ...
    {
        "A", "AA", "AP", "AS", "Border", "C", "Contents", "F", "M", "MK", "NM", "OC", "P", "Rect", "StructParent", "Subtype", "T", "Type"
    };
    public static HashSet<string> AllowedFields_20 { get; } = new HashSet<string> 
    {
        "A", "AA", "AF", "AP", "AS", "BM", "Border", "C", "ca", "CA", "Contents", "F", "Lang", "M", "MK", "NM", "OC", "P", "Rect", "StructParent", "Subtype", "T", "Type"
    };
