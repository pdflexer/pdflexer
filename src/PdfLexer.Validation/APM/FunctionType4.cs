...
internal partial class APM_FunctionType4__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.4m:
                ...
                {
                    ctx.Fail<APM_FunctionType4>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.5m:
            case 1.6m:
    ...
    {
        "DecodeParms", "Domain", "F", "FDecodeParms", "FFilter", "Filter", "FunctionType", "Length", "Range"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "DecodeParms", "DL", "Domain", "F", "FDecodeParms", "FFilter", "Filter", "FunctionType", "Length", "Range"
    };
...
internal partial class APM_FunctionType4_FunctionType__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_FunctionType4_FunctionType>(obj, "FunctionType", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
...
internal partial class APM_FunctionType4_Domain__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfArray, APM_FunctionType4_Domain>(obj, "Domain", IndirectRequirement.Either);
        if (val == null) { return; }
...
internal partial class APM_FunctionType4_Range__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfArray, APM_FunctionType4_Range>(obj, "Range", IndirectRequirement.Either);
        if (val == null) { return; }
...
internal partial class APM_FunctionType4_Length__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetRequired<PdfIntNumber, APM_FunctionType4_Length>(obj, "Length", IndirectRequirement.Either);
        if (val == null) { return; }
        // no special cases
        // no value restrictions
        // no linked objects
...
internal partial class APM_FunctionType4_DL__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        var (val, wasIR) = ctx.GetOptional<PdfIntNumber, APM_FunctionType4_DL>(obj, "DL", IndirectRequirement.Either);
        if (val == null) { return; }
        var DL = obj.Get("DL");
        if (!(gte(DL,0))) 
        {
