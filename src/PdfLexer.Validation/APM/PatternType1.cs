...
internal partial class APM_PatternType1__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            case 1.2m:
                ...
                {
                    ctx.Fail<APM_PatternType1>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.3m:
            case 1.4m:
    ...
    {
        "BBox", "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Matrix", "PaintType", "PatternType", "Resources", "TilingType", "Type", "XStep", "XUID", "YStep"
    };
    public static HashSet<string> AllowedFields_13_14 { get; } = new HashSet<string> 
    {
        "BBox", "DecodeParms", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Matrix", "PaintType", "PatternType", "Resources", "TilingType", "Type", "XStep", "YStep"
    };
    public static HashSet<string> AllowedFields_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "BBox", "DecodeParms", "DL", "F", "FDecodeParms", "FFilter", "Filter", "Length", "Matrix", "PaintType", "PatternType", "Resources", "TilingType", "Type", "XStep", "YStep"
    };
