...
internal partial class APM_FontType3__Base : ISpecification<PdfDictionary>
{
    ...
    public static void Validate(PdfValidator ctx, CallStack stack, PdfDictionary obj, IPdfObject? parent)
    {
        ...
        switch (ctx.Version) {
            ...
            case 1.1m:
                ...
                {
                    ctx.Fail<APM_FontType3>($"Unknown field {extra} for version {ctx.Version}");
                }
                break;
            case 1.2m:
            case 1.3m:
    ...
    {
        "CharProcs", "Encoding", "FirstChar", "FontBBox", "FontDescriptor", "FontMatrix", "LastChar", "Name", "Subtype", "Type", "Widths"
    };
    public static HashSet<string> AllowedFields_12_13_14_15_16_17_18_19_20 { get; } = new HashSet<string> 
    {
        "CharProcs", "Encoding", "FirstChar", "FontBBox", "FontDescriptor", "FontMatrix", "LastChar", "Name", "Resources", "Subtype", "ToUnicode", "Type", "Widths"
    };
